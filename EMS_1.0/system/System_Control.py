...
def restart_system():
    """Function to add new values to employees_base.csv and restart the system if necessary. Also responsible
    ...
    employees_file = Path(__file__).resolve().parent / 'employees_base.csv'
    with open(employees_file, 'r') as f:
        ...
        lines.pop(0)
        #Removing descriptor section in the employees_base.csv file
    ...
    new_password_file = Path(__file__).resolve().parent / 'passwords.csv'
...
def update_employee_file(emp_list):
    """Function that takes the loaded employee list and updates the employees file.. should be updated_updated, jk"""
